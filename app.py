...
def page_dashboard():
    ...
    with c2:
        st.markdown(f'<div class="metric-card"><div>📅 مواعيد اليوم</div><div class="metric-value" style="color:#10b981;">{np.random.randint(2,12)}</div></div>', unsafe_allow_html=True)
    with c3:
